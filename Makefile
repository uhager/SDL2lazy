...
OBJS = $(SRC)/SlTexture.o $(SRC)/SlSprite.o $(SRC)/SlRenderItem.o $(SRC)/SlManager.o $(SRC)/SlTextureManager.o $(SRC)/SlSpriteManager.o $(SRC)/SlSpriteManipulation.o $(SRC)/SlValueParser.o 
