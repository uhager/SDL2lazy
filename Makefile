...
OBJS = $(SRC)/SlTexture.o $(SRC)/SlSprite.o $(SRC)/SlRenderItem.o $(SRC)/SlManager.o $(SRC)/SlTextureManager.o $(SRC)/SlSpriteManager.o $(SRC)/SlManipulation.o $(SRC)/SlSpriteManipulation.o $(SRC)/SlValueParser.o $(SRC)/SlFont.o $(SRC)/SlFormulaItem.o $(SRC)/SlRenderQueueManipulation.o 
